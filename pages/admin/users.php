...
<main class="admin-content">
    ...
    <div class="content-body">
        ...
        <div class="row stats-cards">
            <div class="col-md-3"><div class="stat-card"><div class="stat-number"><?php echo count($users); ?></div><div class="stat-label">Total Users</div></div></div>
            <div class="col-md-3"><div class="stat-card"><div class="stat-number"><?php echo count($activeUsers); ?></div><div class="stat-label">Active Users</div></div></div>
            <div class="col-md-3"><div class="stat-card"><div class="stat-number"><?php echo count($admins); ?></div><div class="stat-label">Administrators</div></div></div>
            <div class="col-md-3"><div class="stat-card"><div class="stat-number"><?php echo count($newUsers); ?></div><div class="stat-label">New This Month</div></div></div>
        </div>
            ...
            <table class="table table-hover">
                ...
                <?php else: ?>
                    <?php foreach ($users as $u): ?>
                        ...
                        ?>
                        <tr
                          data-user-name="<?php echo strtolower(htmlspecialchars($u['name'])); ?>"
                        ...
                        >
                            ...
                            <td><span class="badge role-badge <?php echo 'role-' . $role; ?>"><?php echo htmlspecialchars(ucfirst($role)); ?></span></td>
                            <td><span class="badge status-badge <?php echo 'status-' . $status; ?>"><i class="fas fa-circle me-1" style="font-size:.5em;"></i><?php echo htmlspecialchars(ucfirst($status)); ?></span></td>
                            <td><small class="text-muted"><?php echo date('M j, Y', strtotime($u['created_at'])); ?></small></td>
                            <td>
                                <div class="action-buttons d-flex gap-2">
                                    <a href="user-edit.php?id=<?php echo (int)$u['id']; ?>" class="btn btn-outline-primary" title="Edit">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="deleteModalLabel"><i class="fas fa-exclamation-triangle text-warning me-2"></i>Confirm Delete</h5>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger" id="confirmDeleteBtn"><i class="fas fa-trash me-1"></i>Delete User</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="statusModal" tabindex="-1" aria-labelledby="statusModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="statusModalLabel"><i class="fas fa-toggle-on text-warning me-2"></i>Toggle User Status</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <div class="modal-body">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-warning" id="confirmStatusBtn"><i class="fas fa-toggle-on me-1"></i>Update Status</button>
      </div>
    </div>
  </div>
</div>

...
<section class="media-gallery">
    ...
    <div class="gallery">
        <img src="assets/images/past-project-1.png" alt="Home page for tinchule Dental Care developed by us"
            class="thumbnail">
        <img src="assets/images/past-project-2.png" alt="Admin Dashboard for Rothshire Pty. Ltd  developed by us"
            class="thumbnail">
        <img src="assets/images/past-project-3.png" alt="Website for Rothshire Pty. Ltd  developed by us"
            class="thumbnail">
        <img src="assets/images/past-project-4.png" alt="Personal Website for Abash Shah  developed by us"
            class="thumbnail">
